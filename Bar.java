...
//  The color of the bar AT the breakpoint will be the average color between the safe color and the danger color
    ...
    private boolean mirrorHorizontally = false; // Should the bar be reversed?
    ...
    private void newImage()
    {
        ...
        image.drawImage(rightImg, (maxX + barImg.getWidth())/2, (image.getHeight() - rightImg.getHeight()) / 2);
        setImage(image);
    }
    ...
    public void setMirrorHorizontally() { mirrorHorizontally = true; }
